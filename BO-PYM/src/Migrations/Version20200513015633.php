...
final class Version20200513015633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD token VARCHAR(191) DEFAULT NULL, ADD token_expires_at DATETIME DEFAULT NULL, ADD refresh_token VARCHAR(191) DEFAULT NULL, ADD refresh_token_expires_at DATETIME DEFAULT NULL, ADD is_email_verified TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE Role role VARCHAR(255) DEFAULT \'User\' NOT NULL');
